...
resp = client.register_agent(
        ...
        display_name = "bearerv4",
        description = "Agent that answers questions about gdrive assets. Wehn asked it also described session state",
        tool_description = "Agent that answers questions about gdrive assets and describes session state",
